...
var _excluded2 = ["children", "className", "color", "component", "disabled", "error", "focused", "fullWidth", "hiddenLabel", "margin", "required", "size", "variant"];
...
var FormLabel = React4.forwardRef(function FormLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime4.jsxs)(FormLabelRoot, _extends({
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref
...
var InputLabel = React5.forwardRef(function InputLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime5.jsx)(InputLabelRoot, _extends({
    "data-shrink": shrink,
    ownerState,
    ref,
    className: clsx_default(classes.root, className)
...
var OutlinedInput = React7.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime8.jsx)(InputBase_default, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime8.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime7.jsxs)(React7.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
//# sourceMappingURL=chunk-LPI5IJLD.js.map
